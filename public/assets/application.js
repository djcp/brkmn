        ...
        return $.ajax({
          ...
          success: function(html) {
            ...
            if ($.cookie('hide_filter_control') === 'hide') {
              $('#filters').hide();
              return $('#filter_control span').html('Show filter');
            }
          }
        });
      }
    ...
    $('#filter_control').live({
      click: function(e) {
        ...
        if (filter_viz !== 'hide') {
          ...
          return $.cookie('hide_filter_control', 'hide');
        } else {
          $('#filters').show('slow');
          $('#filter_control span').html('Hide Filter');
          return $.cookie('hide_filter_control', void 0);
        }
      }
    });
    $('#filter').live({
